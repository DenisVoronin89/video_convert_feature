"""  Модуль логики модерации. (НЕ ЗАКОНЧЕН!!!!!) Надо сделать фастапи админку, там будут отображаться профили
 где флаг модерации фалс, модер одобряет - профиль показывается, флаг на тру меняется, тут пока шляпа написана под старый код еше
 Будь внимателен!!!!!
 """
